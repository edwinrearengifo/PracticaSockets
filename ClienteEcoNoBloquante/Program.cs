    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ProtocolType.Tcp);
                socketCliente.Connect(new IPEndPoint(Dns.GetHostEntry(servidor).AddressList[1], puerto));
            }
            catch (Exception e)
            {
            ...
            buferTx = Encoding.ASCII.GetBytes("ESTOY ENVIANDO TODO ESTOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO!");
